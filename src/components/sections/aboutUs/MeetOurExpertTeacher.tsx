    ...
    <section className="custom-container space-y-12">
      ...
      <div className="w-full max-w-[605px] mx-auto space-y-3 text-center">
        ...
        <p className="text-black-secondary text-lg">
          Behind every great course is a great teacher. Discover the expert
          who’s here to guide your learning journey.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full mx-auto">
        {teachers.map((teacher) => (
          <div
            key={teacher.name}
            className="relative w-fit h-fit rounded-xl overflow-hidden group"
          >
            <Image
              src={teacher.image}
              alt={teacher.name}
