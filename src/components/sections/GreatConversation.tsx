...
export default function GreatConversation() {
  ...
  return (
    <section className="custom-container bg-yellow-secondary rounded-4xl relative overflow-hidden">
      <div className="flex flex-row items-center justify-between h-full lg:h-[326px] px-6 lg:px-20">
          <div className="max-w-[642px] w-full space-y-8 z-10">
            <div className="space-y-6">
              ...
              <Image
                ...
                width={484}
                height={424}
                className="block lg:hidden max-w-[484px] w-full h-auto object-contain"
              />
            </div>
            {/* Subscription */}
